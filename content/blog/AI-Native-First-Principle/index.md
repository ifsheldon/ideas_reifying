...
愿景归愿景，但是Sora 的下一步和 AI 第一性原理有什么关系？我们从 Sora 目前能够支持的输入、输出来分析。
...
通过这两个例子和基于 AI 第一性原理的分析，我觉得很多人会对“OpenAI 的边界在哪里”这个问题有更多实感。所以，在这里我觉得还是留给你们读者来总结。可以先喝一口水，回来再想想。*Just let that sink in.*
